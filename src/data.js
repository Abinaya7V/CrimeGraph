...
export const edges = [
  { data: { source: "p_ravi", target: "ph_1", label: "called",
    evidence: "Case A FIR #2291, para 3: phone log extract." } },
  { data: { source: "ph_1", target: "ph_2", label: "called",
    evidence: "Case B CDR row #4471: 14 calls, 12-24 Mar." } },
  { data: { source: "ph_2", target: "p_suresh", label: "registered to",
    evidence: "Telecom subscriber record, Case B." } },
  { data: { source: "p_ravi", target: "v_1", label: "uses",
    evidence: "Surveillance report, Case C: vehicle association." } },
  { data: { source: "v_1", target: "l_transit", label: "seen near",
    evidence: "Surveillance log entries, 3 occurrences, April." } },
  { data: { source: "p_ravi", target: "a_1", label: "linked to",
    evidence: "Bank KYC cross-reference, Case C." } },
  { data: { source: "a_1", target: "p_anita", label: "transferred to",
    evidence: "Transaction record, Case C, Acc XXXX7743 -> Anita R." } },
  { data: { source: "p_suresh", target: "l_mumbai", label: "located in",
    evidence: "CDR tower triangulation, Case B." } },
  { data: { source: "p_ravi", target: "l_chennai", label: "based in",
    evidence: "FIR filing address, Case A." } },
  { data: { source: "p_suresh", target: "ph_3", label: "called",
    evidence: "Case D CDR (Kerala unit), cross-referenced by phone number match." } },
  { data: { source: "ph_3", target: "p_deepak", label: "registered to",
    evidence: "Telecom subscriber record, Case D." } },
  { data: { source: "p_deepak", target: "p_unknown", label: "associated with",
    evidence: "Surveillance report, Case D, joint appearance at Mumbai Node location." } },
  { data: { source: "p_unknown", target: "l_mumbai", label: "seen at",
